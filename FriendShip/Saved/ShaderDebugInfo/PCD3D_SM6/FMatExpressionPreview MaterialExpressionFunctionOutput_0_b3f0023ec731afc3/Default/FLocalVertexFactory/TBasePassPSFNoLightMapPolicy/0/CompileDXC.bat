@ECHO OFF
SET DXC="C:\Games\UE_5.7\Engine\Binaries\ThirdParty\ShaderConductor\Win64\dxc.exe"
IF NOT EXIST %DXC% (
	ECHO Couldn't find dxc.exe under "C:\Games\UE_5.7\Engine\Binaries\ThirdParty\ShaderConductor\Win64"
	GOTO :END
)
